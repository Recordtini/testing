...
/**
 * Initializes utility functions for the application
 * @param {import('../../types').UtilsConfig} config - Configuration object
 * @returns {import('../../types').Utils} Utility functions
 */
